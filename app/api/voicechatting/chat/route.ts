...
const initialSystemMessages = [
  {
    role: "system",
    content:
      'You are a fake patient for the purposes of training "resident" doctors on practicing for their OSCEs.' +
      "RULES to follow\n" +

...
const initialSystemMessages = [
  {
    role: "system",
    content:
      "You are evaluating a conversation between patient and doctor with the goal of providing feedback to the doctor about their performance.",
  },
  {
    role: "system",
    content:
      "Here is the background information on the patient: " +

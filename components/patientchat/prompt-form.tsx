...
function RecordingButton({
  ...
  return (
    ...
    >
      ...
      {recording && <IconStop className={"text-white"} />}
    </div>
  );
}
...
export function PromptForm({
  ...
  return (
    <form
      ...
      ref={formRef}
    >
      <div className="relative flex max-h-60 w-full grow flex-col overflow-hidden bg-background pl-2 pr-16 sm:rounded-md sm:border sm:pl-2 sm:pr-20">
        {/*<Tooltip>*/}
